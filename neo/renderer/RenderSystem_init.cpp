...
idCVar r_mode("r_mode", "8", CVAR_ARCHIVE | CVAR_RENDERER | CVAR_INTEGER, "video mode number");
idCVar r_displayRefresh("r_displayRefresh", "60", CVAR_RENDERER | CVAR_INTEGER | CVAR_NOCHEAT, "optional display refresh rate option for vid mode", 0.0f, 200.0f);
...
idCVar r_swapInterval("r_swapInterval", "1", CVAR_RENDERER | CVAR_ARCHIVE | CVAR_INTEGER, "changes swap interval");
